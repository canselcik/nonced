...
func TestTxnIO(t *testing.T) {
	assert.Equal(t, "4730440220d47ce4c025c35ec440bc81d99834a6" +
		"24875161a26bf56ef7fdc0f5d52f843ad1022044e1ff2dfd8102cf7a47c21d" +
		"5c9fd5701610d04953c6836596b4fe9dd2f53e3e014104dbd0c61532279cf7" +
		"2981c3584fc32216e0127699635c2789f549e0730c059b81ae133016a69c21" +
	...
	assert.Equal(t, "4730440220d47ce4c025c35ec440bc81d998" +
		"34a624875161a26bf56ef7fdc0f5d52f843ad102209a5f1c75e461d7c" +
		"eb1cf3cab9013eb2dc85b6d0da8c3c6e27e3a5a5b3faa5bab014104db" +
		"d0c61532279cf72981c3584fc32216e0127699635c2789f549e0730c0" +
		"59b81ae133016a69c21e23f1859a95f06d52b7bf149a8f2fe4e8535c8" +
		"a829b449c5ff",
...
func TestZValueExtraction(t *testing.T) {
	...
	inputHashA, _ := txscript.CalcSignatureHash(_prevParsedTxnA.MsgTx().TxOut[1].PkScript,
		txscript.SigHashAll, _vulnParsedTxn.MsgTx(), 0)
	inputHashB, _ := txscript.CalcSignatureHash(_prevParsedTxnB.MsgTx().TxOut[1].PkScript,
		txscript.SigHashAll, _vulnParsedTxn.MsgTx(), 1)
	assert.Equal(t, "c0e2d0a89a348de88fda08211c70d1d7e52ccef2eb9459911bf977d587784c6e",
		hex.EncodeToString(inputHashA), "wrong z1")
	assert.Equal(t, "17b0f41c8c337ac1e18c98759e83a8cccbc368dd9d89e5f03cb633c265fd0ddc",
		hex.EncodeToString(inputHashB), "wrong z2")
}
